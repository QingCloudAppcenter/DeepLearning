...
parser.add_argument('--master-addr', default='192.168.1.1', type=str,
                    help='distributed master address')
parser.add_argument('--master-port', default='29500', type=str,
                    help='distributed master port')
parser.add_argument('--world-size', default=2, type=int,
                    help='wordsize of distributed processes')
...
dist.init_process_group(backend='gloo', init_method='env://', rank=args.rank, world_size=args.world_size)
